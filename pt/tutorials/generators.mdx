...
### Duração 
Em uma expressão de eixo no eixo de duração, o menor valor que pode ser gerado é 1/subdivisão. Durations menos que ou igual de 0 não é possível, então a duração será Max(valor, 1/subdivisão)
