---
title: Tutorial - Intro to WereSoCool
next: overtones
---
...
-- [SECRET] Pressing Shift-Enter will also play
-- [SECRET] As songs get longer, you might want to 
-- [SECRET] stop them with cmd + enter (ctl + enter on linux/windows).
{ f: 220, l: 1, g: 1, p: 0 }\n
main = {
  Fm 1
}`
