...
-- so Fm 2 is the same note up an octave and 
-- Fm 4 would be another octave above that. 
Fm 2
Fm 4
-- Fm values less than 1 will bring the frequency down.
-- Fm 1/2 is the same note down an octave
Fm 1/2
-- Fm 0 is silent.
Fm 0`
}/>
...
<WereSoCool language={`
-- lines that start with dashes are comments 
-- and will not be run.
-- Pressing Shift-Enter will also play
