...
The **WereSoCool CLI** is availble on **macOS**, **Linux** and **Windows**. You can also explore the language on Firefox and Chrome browsers in the **<CoolLink href={"/playground"}>WereSoCool Playground</CoolLink>**. 
