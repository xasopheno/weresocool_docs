export const artist = {
  date: "5/21/20",
  location: "NYC",
  name: "Jesse Harris and Jeremy Gustin",
  instrument: "Songs, Drums",
  bio: [
  ...
  links: [
    {
      text: "Jesse's Website",
      link: "http://jesseharrismusic.com/",
    },
    {
      text: "Listen to Jesse's record, Songs Never Sung",
      link:
        "https://open.spotify.com/album/3gYabl5yQx3MzHiWVB6BZX?si=b0b3gR5DTrqtwVgN3EF6gw",
    },
    {
      text: "Listen to Jeremy's record, Mere Husk",
      link:
        "https://open.spotify.com/album/74AfEkfLAPksphOCUfYUT5?si=3_hnVOdXREeQTawZJTWPTQ",
    },
  ],
  payment: {
    venmo: "/jesse_qr.png",
  ...
  charity: {
    ...
    link: "https://www.foodbanknyc.org/donate/",
  },
};
